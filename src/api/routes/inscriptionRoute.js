module.exports = (server) => {
    ...
    server.route('/inscription')
        ...
        //all users
        .post(jwtMiddleware.verify_token_and_admin, inscriptionController.register_inscription);

    server.route('/inscription/:inscription_id') // req.params.inscription_id
        // team
        .get(inscriptionController.get_an_inscription)
        //owner
        .put(jwtMiddleware.verify_token_and_admin, inscriptionController.update_an_inscription)
        //owner
        .delete(jwtMiddleware.verify_token_and_admin, inscriptionController.delete_an_inscription);
